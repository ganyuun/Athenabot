...
bot = commands.Bot(command_prefix='$', activity = discord.Game(name="music"), status=discord.Status.online)
...
@bot.event
async def on_ready():
  game = discord.Game("music! | prefix $")
  await bot.change_presence(status=discord.Status.online, activity=game)

bot.run("OTE5NDUzNDM1MzM2NzM2ODE5.YbWBvQ.oYsc-LNmF_CSWwT2EwJ2zinpH2w")